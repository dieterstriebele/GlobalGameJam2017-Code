...
public class Settings {
	...
	public final static int DeathCircleId = IGeometryInformation.cOBJECTMODELIDENTIFICATION_BRAINMINE;
	public final static Vector3D DeathCircleScale = new Vector3D(0.1f, 0.1f, 0.1f);

	// Howler
	public static final float HowlerSpeed = 0.0002f;
	public static final int HowlerId = IGeometryInformation.cOBJECTMODELIDENTIFICATION_BRAINMINE;
    ...
    public final static int SpiralId = IGeometryInformation.cOBJECTMODELIDENTIFICATION_BRAINMINE;
	public final static Vector3D SpiralScaling = new Vector3D(0.5f, 0.5f, 0.5f);

    // Wesp
	public static final float WespSpeed = 0.0005f;
    public final static int WespId = IGeometryInformation.cOBJECTMODELIDENTIFICATION_BRAINMINE;
